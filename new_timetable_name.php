...
if(isset($_POST['tablename'])){
    ...
    header("location:http://localhost/php_batch/practice/timetable/create_table.php");
}
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        <form id="login-form" class="form" action="new_timetable_name.php" method="post">
                            <h3 class="text-center text-info">Create New Timetable</h3>
